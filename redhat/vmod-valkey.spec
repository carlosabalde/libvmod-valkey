...
Requires: varnish >= 7.6.0, libvalkey >= 0.1.0, libev >= 4.03
BuildRequires: make, python-docutils, varnish >= 7.6.0, varnish-devel >= 7.6.0, libvalkey-devel >= 0.1.0, libev-devel >= 4.03
