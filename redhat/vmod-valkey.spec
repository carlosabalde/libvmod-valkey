...
Requires: varnish >= 7.7.0, libvalkey >= 0.1.0, libev >= 4.03
BuildRequires: make, python-docutils, varnish >= 7.7.0, varnish-devel >= 7.7.0, libvalkey-devel >= 0.1.0, libev-devel >= 4.03
...
%changelog
* Tue Mar 18 2025 Carlos Abalde <carlos.abalde@gmail.com> - 3.0-1.20250318
- Migrated to Varnish Cache 7.7.x.
* Fri Sep 13 2024 Carlos Abalde <carlos.abalde@gmail.com> - 2.0-1.20240913
